...
/**
 * Order - Represents an order in the TechStore system. Maps to the SQL table
 * [Order].
 *
 * @author <Your Name>
 */
public class Order {
    ...
    public Order(int orderId, String cusId, Timestamp orderDate, BigDecimal totalAmount, BigDecimal discountAmount, BigDecimal finalAmount, Integer voucherId, String orderStatus, String paymentMethod, String shippingAddress, String receiverName, String receiverPhone, List<OrderDetail> orderDetails) {
